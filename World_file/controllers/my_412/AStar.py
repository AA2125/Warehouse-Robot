...
#astar is the biggest function

#- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - just to explain the process

#init your nodes
#     so we convert the occupancy grid into a node list
#     each node has property of g h f

# # setup the start and goal nodes
#     you want to convert the cartesian coordinate of robopose and goal into grid indices(what are g indices?)

    
#     init start node
#         it gets g = 0
#                 h =  direct distance to goal
#                 f =  sum of g and h
...
def createNodesList(occupancy_grid):
    ...
    #this fn should take in the occupancy grid and convert it into a node list
    #what is a node list???
    nodes = []
    row_counter = 0
...
def aStar(robot_x, robot_y, goal_x, goal_y, occupancy_grid):
    ...
    #takes the robot coordinates
    # and takes the goal coordinates
    #then takes the occupancy grid
